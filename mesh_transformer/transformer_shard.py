...
class CausalTransformerShard(hk.Module):
    ...
    def generate_initial(self, context, length, return_logits=True, return_last_hidden_states=False):
    ...
    def generate_once(self, new_tok, state, return_logits=True, return_last_hidden_states=False):
